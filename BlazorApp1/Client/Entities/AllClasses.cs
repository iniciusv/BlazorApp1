...
public class Cliente : Usuario, IEntity
{
	...
	public Cliente(long id, string cpf, string nome, string endereco, string? telefone, string celular,
					  string habilitacao, string categoriaHabilitacao, Collection<Locacao> locacoes, string? email,
					  DateTime dataNascimento, string senha)
	{
		...
		Locacoes = locacoes ?? new Collection<Locacao>();
		Email = email;
